...
export class Card {
  constructor(data, userData, cardConstructor) {
    this._data = data;
  ...
  like() {
    this._likeButton.classList.add('element__like_active');
    //this._element.querySelector('.element__likes-counter').textContent = this._getLikesCounter();
  };
  ...
  _setEventListeners() {
    ...
    this._likeButton.addEventListener('click', () => {
      if (!this._likeButton.classList.contains('element__like_active')) {
        handleLike(this._id, this._element);
      } else {
        setLikesUpdateDelete(this._id, this._element)
      }
    });
